...
router.get('/counts', async (req, res) => {
  try {
    ...
    // Get ANIMAL counts from animals collection (use high limit for accurate counts)
    ...
    const landTracts = await firestoreService.getLandTracts(userData.tenantId, { siteId, status: 'ALL', limit: 10000 });
